...
import space.accident.structurelib.structure.IStructureElement;
...
import static space.accident.structurelib.structure.StructureUtility.ofChain;
import static space.accident.structurelib.structure.StructureUtility.onElementPass;
import static space.accident.structurelib.structure.StructureUtility.transpose;
...
public class GT_MetaTileEntity_PyrolyseOven extends GT_MetaTileEntity_EnhancedMultiBlockBase<GT_MetaTileEntity_PyrolyseOven> {
    ...
    private static IStructureDefinition<GT_MetaTileEntity_PyrolyseOven> createStructureDefinition() {
        IStructureElement<GT_MetaTileEntity_PyrolyseOven> tCasingElement = ofBlock(GregTech_API.sBlockCasings1, 0);
